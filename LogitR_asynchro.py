...
parameter_servers = ["10.24.28.111:2222","10.24.28.112:2223"]
workers = ["10.24.28.112:2224", "10.24.28.113:2225"]
...
if FLAGS.job_name == "ps":
	...
	np.save("epoch_loss_asynchro_w1",epoch_loss_w1)
	np.save("epoch_loss_asynchro_w2",epoch_loss_w2)
	np.save("test_acc_asynchro_w1",test_acc_w1)
	np.save("test_acc_asynchro_w2",test_acc_w2)
